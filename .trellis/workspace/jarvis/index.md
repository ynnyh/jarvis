...
|---|------|-------|---------|--------|
| 11 | 2026-06-11 | 对话式发版打通：配置/连接体验重做 + 发版闭环 + 多项修复 | `662f31c`, `9fa1f79` | `main` |
...
| 2 | 2026-06-02 | 设置页改造：单窗口 + 侧边栏，10页合并为6页 | `8111746` | `main` |
| 1 | 2026-06-02 | 批量写工时窗口 + 今日计划工时估算与任务搜索 | `3250e12` | `main` |
<!-- @@@/auto:session-history -->
