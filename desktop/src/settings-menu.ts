...
export type SettingsPageKey = 'general' | 'zentao' | 'finereport' | 'ai' | 'channels' | 'deploy' | 'code' | 'dailyNudges' | 'effortClosing' | 'personalization' | 'about'
...
export const SETTINGS_MENU: SettingsMenuItem[] = [
  { key: 'general', title: '常规', desc: '开机自启与功能开关', group: '常规', groupOrder: 0 },
  ...
  { key: 'deploy', title: '对话式发版', desc: 'Jenkins 连接与项目预设', group: '接入', groupOrder: 1 },
...
export const SETTINGS_PAGE_COMPONENTS: Record<SettingsPageKey, Component[]> = {
  general: [AutoStartSection, DeployEnableSection],
  ...
  personalization: [AssistantNameSection, StyleThemeSection, MenuThemeSection, WorkStyleSection, PetSection, LeftClickActionSection],
