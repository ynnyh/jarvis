...
export const SETTINGS_MENU: SettingsMenuItem[] = [
  ...
  { key: 'ai', title: 'AI 模型', desc: '服务商、模型与 API Key', group: '接入' },
  { key: 'channels', title: '聊天渠道', desc: 'Telegram 与 QQ Bot', group: '接入' },
  { key: 'code', title: '代码与日报', desc: '仓库目录和业务线过滤', group: '工作流' },
  { key: 'schedule', title: '作息规则', desc: '工作日、时段和静默策略', group: '提醒' },
  { key: 'effortClosing', title: '工时提醒', desc: '下班后检查今日工时', group: '提醒' },
  { key: 'nudges', title: '主动提醒', desc: '问候、今日计划和收尾提醒', group: '提醒' },
  { key: 'appearance', title: '外观与行为', desc: '称呼、形象和工作模式', group: '个性化' },
